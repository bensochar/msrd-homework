<template>
  <legend>Please enter your {{ user.current_step }}</legend>
  <form @submit.prevent="emit('onSubmit', form)">
    <div v-if="user.current_step == 'email'" class="position-relative mb-3">
    ...
    <div v-if="user.current_step == 'weight'" class="position-relative mb-3">
    ...
    <div v-if="user.current_step == 'birthdate'" class="position-relative mb-3">
